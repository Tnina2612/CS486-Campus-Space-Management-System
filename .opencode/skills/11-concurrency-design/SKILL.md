...
5. **Incident-to-Maintenance Triage Concurrency:** Describe how to avoid duplicate maintenance records when multiple managers triage overlapping/duplicate `INCIDENT_REPORT` sets concurrently.
